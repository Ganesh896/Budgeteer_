...
import { addExpense, updateExpense, deleteExpense, getExpenses, getCategory, getExpenseById, getExpenseByCategories } from "../controller/expense";
...
router.get("/categories/amount", authenticate, getExpenseByCategories);
